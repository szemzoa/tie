...
extern void apply_rope_cache_bf16_avx2(RopeCacheType *rope_cache, void *X, int pos, int head_dim);
...
extern void store_KV_cache_bf16_bf16_avx2(struct TIEContext *ctx, int layer_idx, int start_pos, int batch_len);
