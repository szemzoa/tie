...
extern void dispatch_mat_vec(struct ctx_t *ctx, const MemType *X, const Tensor *W, MemType *O, int in_dim, int out_dim,
			     int use_threads);
extern void dispatch_mat_mat(struct ctx_t *ctx, const MemType *X, const Tensor *W, MemType *O, int batch_len,
			     int in_dim, int out_dim, int use_threads);
extern void dispatch_apply_rope_cache(struct ctx_t *ctx, rope_cache_t *rope_cache, MemType *X_slice, int pos,
				      int head_dim);
