...
extern void mat_vec_row_f32_q4k_bf16_scalar(const void *X, const void *w_void, void *O, int in_dim, int start_row, int end_row);
...
extern void layer_norm_f32_f32_f32_f32_scalar(MemType *dest, const MemType *src, const Tensor *weight, const Tensor *bias, int size, float eps);
